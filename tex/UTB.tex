...
\usepackage{pgfgantt}   % Gantův diagram
\usepackage{pdflscape}  % stránky "naležato" (landscape orientation)
...
% definice url prikazu pro bibtex
...
\newcommand{\valueSideMargin}{0cm}	% levý okraj; původně 0.96cm
...
\newcommand{\aplikujpdfa}{
    ...
    \else \ifslovak
		\providecommand{\xmpTitle}{\nazevsk}
		\providecommand{\xmpAuthor}{\autor}
		\providecommand{\xmpKeywords}{\klicovaslovask}
		\hypersetup{
			pdftitle={\nazevsk},
			pdfauthor={\autor},
			pdfsubject={\abstraktsk},
			pdfkeywords={\klicovaslovask},
			pdflang={en}
		}
	\fi \fi \fi
...
% Styl pro dlouhe tabulky
% \ltab{popisek}{label}{definice sloupců}{obsah} 
\def\ltab#1#2#3#4{
\begin{longtable}[c]{#3}
\caption{#1 \label{#2}}\\
...
\newcommand{\OdsazovaniOdstavcuStart}[0]{
    ...
    \else \ifslovak
		\setlength{\parindent}{5mm} % Slovak indentation of paragraphs
	\fi \fi \fi
}
...
\newcommand{\OdsazovaniOdstavcuStop}[0]{
    ...
    \else \ifslovak
		\setlength{\parindent}{0mm} % Slovak indentation of paragraphs
	\fi \fi \fi
}
...
\newcommand{\seznamlitbib}{
	...
	\bibliographystyle{tex/czechiso} % Respects the norm of ČSN ISO 690, alternative
	\newpage
	\clearpage
	%\cleardoublepage
	\addcontentsline{toc}{section}{\ifenglish References \else \ifczech Seznam použité literatury \else \ifslovak Zoznam použitej literatúry \fi \fi \fi}
...
\newcommand{\seznamzkr}{
    ...
    \else \ifslovak
		\nn{Zoznam použitých symbolov a skratiek}
	\fi \fi \fi
}
...
\newcommand{\zadani}[1]{
	\clearpage
	\thispagestyle{empty}
	\includepdf[pages={1-2}, offset=0 -50]{#1}
}

\newcommand{\zadanispuk}[1]{
    \clearpage
    \thispagestyle{empty}
    \ifczech
    \nns{Zadání}
...
\newcommand{\aktivujZahlavi}{
    ...
    \else \ifslovak
        \lhead{\b{UTB v Zlíne, \ifthenelse{\equal{\fakulta}{FAI}}{Fakulta aplikované informatiky}{\ifthenelse{\equal{\fakulta}{FAME}}{Fakulta managementu a ekonomiky}{\ifthenelse{\equal{\fakulta}{FHS}}{Fakulta humanitních studií}{\ifthenelse{\equal{\fakulta}{FLKR}}{Fakulta logistiky a krizového řízení}{\ifthenelse{\equal{\fakulta}{FMK}}{Fakulta multimediálních komunikací}{\ifthenelse{\equal{\fakulta}{FT}}{Fakulta technologická}{\ifthenelse{\equal{\fakulta}{UNI}}{Univerzitní institut}{}}}}}}}}}
	\fi \fi \fi
}
...
\newcommand{\logopracerok}{
	...
	\ifczech
		\ifbp \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Bakalářská práce}} \fi
		\ifdp \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Diplomová práce}} \fi
		\ifsp \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Semestrální projekt}} \fi
		\ifuk \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Úkol \ukolcislo \ukolpredmet}} \fi
	\else \ifenglish
		...
		\ifsp \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Semester project}} \fi
		\ifuk \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Assign. \ukolcislo \ukolpredmet}} \fi
    \else \ifslovak
		\ifbp \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Bakalárska práca}} \fi
		\ifdp \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Diplomová práca}} \fi
		\ifsp \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Semestrálny projekt}} \fi
		\ifuk \put(4,-214){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}Úloha \ukolcislo \ukolpredmet}} \fi
	\fi \fi \fi
	\put(4,-221){\makebox(69.5,4.5)[l]{\noindent\fontsize{16}{1}\usefont{OT1}{phv}{m}{n}\rok}}
	\put(0,-225){\linethickness{1pt}\line(1,0){170}}
	\put(80,-223.3){\linethickness{1pt}\line(0,1){16.4}}
}
...
\newcommand{\priloha}[1]{
    ...
    \else \ifslovak
		{\bf PRÍLOHA P \@Roman\c@section. \MakeTextUppercase{#1}}
	\fi \fi \fi
	\par
}
...
\newcommand{\nastavtyp}[1]{
	...
	\newif\ifuk \let\ifuk\iffalse
	
	\ifthenelse{\equal{#1}{BP}}{\let\ifbp\iftrue}{}
	\ifthenelse{\equal{#1}{DP}}{\let\ifdp\iftrue}{}
	\ifthenelse{\equal{#1}{SP}}{\let\ifsp\iftrue}{}
	\ifthenelse{\equal{#1}{UK}}{\let\ifuk\iftrue}{}
	
	\ifbp \else \ifdp \else \ifsp \else \ifuk \else
		\errmessage{Chyba nastaveni typu prace}
	\fi \fi \fi \fi
}

\newcommand{\nastavcisloukolupredmet}[2]{
    \ifx\relax#1\relax
        \newcommand{\ukolcislo}{}
    \else
        \ifenglish
            \newcommand{\ukolcislo}{\##1 }
        \else
            \newcommand{\ukolcislo}{č.#1 }
        \fi
    \fi
    \ifx\relax#2\relax
        \newcommand{\ukolpredmet}{}
    \else
        \ifczech
            \newcommand{\ukolpredmet}{pro předmět #2}
        \else \ifenglish
            \newcommand{\ukolpredmet}{for course #2}
        \else \ifslovak
            \newcommand{\ukolpredmet}{pre predmet #2}
        \fi \fi \fi
    \fi
}
...
% Nastaveni podnazvu
\newcommand{\nastavpodnazevcz}[1]{
	\newcommand{\podnazevcz}{#1}
}
\newcommand{\nastavpodnazeven}[1]{
	\newcommand{\podnazeven}{#1}
}
\newcommand{\nastavpodnazevsk}[1]{
	\newcommand{\podnazevsk}{#1}
}
...
\newcommand{\nastavklicovaslovask}[1]{
	\newcommand{\klicovaslovask}{#1}
}
...
\newcommand{\nastavjazyk}[1]{
    ...
    \ifthenelse{\equal{#1}{SK}}{\let\ifslovak\iftrue}{}
	
	\ifczech \else \ifenglish \else \ifslovak \else
    ...
    \else \ifslovak
		...
		% Vlastni definice nazvu
		\addto\captionsslovak{\renewcommand{\contentsname}{\MakeTextUppercase{Obsah}}}
		\addto\captionsslovak{\renewcommand{\refname}{\MakeTextUppercase{Zoznam použitej literatúry}}}
		\addto\captionsslovak{\renewcommand{\listfigurename}{\MakeTextUppercase{Zoznam obrázkov}}}
		\addto\captionsslovak{\renewcommand{\listtablename}{\MakeTextUppercase{Zoznam tabuliek}}}
